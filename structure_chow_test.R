...
summary(panel01)
LOGSAL_12<- LOGSAL[JOBCAT!=3]
EDUC_12<- LOGSAL[JOBCAT!=3]
LOGSALBEGIN_12<- LOGSAL[JOBCAT!=3]
GENDER_12<- GENDER[JOBCAT!=3]
MINORITY_12<- MINORITY[JOBCAT!=3]
panel02<- lm(LOGSAL_12 ~ EDUC_12 + LOGSALBEGIN_12 + GENDER_12 + MINORITY_12)
summary(panel02)
LOGSAL_3<- LOGSAL[JOBCAT==3]
EDUC_3<- LOGSAL[JOBCAT==3]
LOGSALBEGIN_3<- LOGSAL[JOBCAT==3]
...
In anova.lmlist(object, ...) :
  models with response ‘"LOGSAL_3"’ removed because response 
differs from mo
...
Warning message:
In anova.lmlist(object, ...) :
  models with response ‘"LOGSAL_12"’ removed because response 
...
Warning message:
In anova.lmlist(object, ...) :
  models with response ‘c("LOGSAL_12", "LOGSAL_3")’ removed because re
