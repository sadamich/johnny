...
### W
###           [,1]       [,2]       [,3]
###[1,] 1.07572376 0.05246460 0.08457623
###[2,] 0.09922296 1.03721399 0.07287978
###[3,] 0.09140478 0.06616082 1.00344095
### D
...
Function value: -3.065299e-14 
Estimates:
         estimate      gradient
[1,] 6.134875e-08 -1.668574e-07
[2,] 9.687775e-08 -2.262107e-07
[3,] 1.146353e-07 -2.543257e-07
...
(anal-num)/(0.5*(abs(anal)+abs(num)))
              mu         sigma
[1,] 6.14865e-10 -1.182815e-09
Max relative difference: 1.182815e-09 
-------- END of compare derivatives -------- 
...
Call:lm(formula = y ~ -1 + x1 + x2 + x3 + x4)
Residuals:
     Min       1Q   Median       3Q      Max 
-2.01025 -0.50270  0.03936  0.49757  2.37986 
Coefficients:
     Estimate Std. Error t value Pr(>|t|)    
x1  2.692e+05  2.969e+05   0.907  0.36692    
x2  2.692e+05  2.969e+05   0.907  0.36692    
x3 -2.692e+05  2.969e+05  -0.907  0.36692    
x4  9.710e-01  2.728e-01   3.560  0.00058 ***
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
Residual standard error: 0.9427 on 96 degrees of freedom
Multiple R-squared:  0.8891,    Adjusted R-squared:  0.8845 
F-statistic: 192.5 on 4 and 96 DF,  p-value: < 2.2e-16
...
Call:lm(formula = x3 ~ -1 + x1 + x2)
Residuals:
       Min         1Q     Median         3Q        Max 
-7.817e-07 -1.739e-07  4.917e-08  2.895e-07  6.657e-07 
Coefficients:
    Estimate Std. Error  t value Pr(>|t|)    
x1 1.000e+00  9.744e-08 10263046   <2e-16 ***
x2 1.000e+00  8.604e-08 11622140   <2e-16 ***
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
Residual standard error: 3.323e-07 on 98 degrees of freedom
Multiple R-squared:      1,     Adjusted R-squared:      1 
F-statistic: 4.753e+14 on 2 and 98 DF,  p-value: < 2.2e-16
